...
''Source: <Feel CD Backup>\FeelProject\Feel Backups\Feel 2.0 20140730\Feel\clsConfig.vb
Public Class clsConfig_1
#Region "clsConfig"
    ...
    <Serializable()> _
    Public Class clsConfig1
        'MIDI Connections (Virtual ports & MIDI devices)
        Public Connections As Collections.Generic.Dictionary(Of Integer, clsConnection_1)
        ...
        Public Sub New()
            ...
            DmxinEnable = False
            DmxoverEnable = False
            Connections = New Collections.Generic.Dictionary(Of Integer, clsConnection_1)
        End Sub
    End Class

    <Serializable()> _
    Public Class clsConnection_1
        ...
        Public Control As Collections.Generic.Dictionary(Of String, clsConfig_1.clsControl_1)
        ...
        Public Sub New()
            ...
            Control = New Collections.Generic.Dictionary(Of String, clsConfig_1.clsControl_1)
        End Sub
    ...
    <Serializable()> _
    Public Class clsControl_1
        Public Paged As Boolean
        'String is format "WW"
        Public Page As Collections.Generic.Dictionary(Of Byte, clsConfig_1.clsControlPage_1)

        Public Sub New()
            Paged = False
            Page = New Collections.Generic.Dictionary(Of Byte, clsConfig_1.clsControlPage_1)
        End Sub
    End Class

    <Serializable()> _
    Public Class clsControlPage_1
        ...
        Public Actions As Collections.Generic.List(Of clsConfig_1.clsAction_1)
        Public ActionsOff As Collections.Generic.List(Of clsConfig_1.clsAction_1)
        ...
        Public Sub New()
            ...
            IsActive = False
            _CurrentState = ""
            Actions = New Collections.Generic.List(Of clsConfig_1.clsAction_1)
            ActionsOff = New Collections.Generic.List(Of clsConfig_1.clsAction_1)
        End Sub
...
#Region "Internal Actions"
    ...
    Public Class clsActionIntConfigActions
        Implements clsConfig_1.iAction_1
        ...
        <Browsable(False)> _
        Public ReadOnly Property Description() As String Implements clsConfig_1.iAction_1.Description
            Get
                Return _Description
            End Get
        End Property

        Public Function Execute(ByVal Device As String, ByVal Type As Byte, ByVal Channel As Byte, ByVal NoteCon As Byte, ByVal VelVal As Byte) As Boolean Implements clsConfig_1.iAction_1.Execute
            'main.OpenActionWindow()
            Return True
        End Function

        <Browsable(False)> _
        Public ReadOnly Property Name() As String Implements clsConfig_1.iAction_1.Name
            Get
                Return _Name
            End Get
        End Property
    ...
    '    Implements clsConfig_1.iAction
    ...
    '    <Browsable(False)> _
    '    Public ReadOnly Property Description() As String Implements clsConfig_1.iAction.Description
    '        Get
    '            Return _Description
    '        End Get
    '    End Property

    '    Public Function Execute(ByVal Device As String, ByVal Type As Byte, ByVal Channel As Byte, ByVal NoteCon As Byte, ByVal VelVal As Byte) As Boolean Implements clsConfig_1.iAction.Execute
    '        'TODO:
    ...
    '    <Browsable(False)> _
    '    Public ReadOnly Property Name() As String Implements clsConfig_1.iAction.Name
    '        Get
    '            Return _Name
    '        End Get
    '    End Property
