...
Public Class clsConfig
    ...
    Public Connections As Collections.Generic.Dictionary(Of String, clsConnection)
    ...
    Public Sub New()
        ...
        DmxinEnable = False
        DmxoverEnable = False
        Connections = New Collections.Generic.Dictionary(Of String, clsConnection)
    End Sub
End Class
...
Public Class clsConnection
    ...
    Public InputName As String 'TODO: Need this?
    Public InputEnable As Boolean
    Public Output As Integer
    Public OutputName As String 'TODO: Need this?
    ...
    Public Sub New()
        ...
        Name = "New Connection"
        Input = -1
        InputName = "" 'TODO: Need this?
        InputEnable = False
        Output = -1
        OutputName = "" 'TODO: Need this?
        OutputEnable = False
